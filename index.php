...
<body>
    <style type="text/css">
        ...
        a.white-text.text-lighten-4.right {
    ...
    <body>
 		 <nav>
 			...
 			<div class="parallax-container">
  	 		<div class="parallax"><img src="img/backgroundschool.jpg">
			     </div>
							<br>
								<br>
									<br>
      ...
      <div class="firstContent  ">
               <span>lorem Ipsum</span>
			        ...
			        <a class="waves-effect waves-light btn right">button</a>
     					...
     					<div class="col s12 m6 l6 "><p><img class="responsive-img" src="img/schoolBinan.jpg"></p></div>
  					</div>
         		 </div>
       		  </div>


	    <div id="secondContent" class="row #eeeeee grey lighten-3">
	  <div class="container"> 
...
<div class="container">
      <div class="row ">
      	 ...
      	 <div class="col s12 m6 l6 center"><p><img class="responsive-img" src="img/puplogo.png" height="300xp" width="300px"></p></div>
      <div class="col l6 s12 ">
      <div class="firstContent ">
               <span>lorem Ipsum</span>
        <p>
        ...
        <a class="waves-effect waves-light btn">button</a>
          ...
          <div class="container">
            <div class="row">
              <div class="col l6 s12">
                <img class="responsive-img logo-img"  src="img/puplogo.png"> <p>Polytechnic University Of The Philippines</p>
                <p class="grey-text text-lighten-4">
                		Biñan, Laguna
Polytechnic University of the Philippines Biñan, Address

<p>
	
Polytechnic University of the Philippines, Biñan or PUP Biñan is a PUP campus located in City of Biñan, Laguna, Philippines, offering eleven course, one diploma program and undergraduate
